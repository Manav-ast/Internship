...
<main>
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row sm:space-x-4 mb-6">
            <div class="flex-1 p-4 bg-white rounded-lg text-center mb-4 sm:mb-0">
                <p class="text-lg font-bold">Lifetime Expenses (&#8377;) :</p>

                <span id="lifetime-expenses" class="font-semibold text-lg"><?= $total[0]['total'] ?? '0' ?></span>
            </div>
            <div class="flex-1 p-4 bg-white rounded-lg text-center mb-4 sm:mb-0">
                <p class="text-lg font-bold">Total this Month (&#8377;) :</p>
                <span id="total-expenses" class="font-semibold text-lg"><?= $monthTotal[0]['monthTotal'] ?? '0' ?></span>
            </div>
            <div class="flex-1 p-4 bg-white rounded-lg text-center">
                <p class="text-lg font-bold">Highest this Month (&#8377;) :</p>
